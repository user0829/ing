...
<head>
    ...
    <link rel="stylesheet" href="${basePath}/superui/superui-master/content/adminlte/dist/css/skins/_all-skins.css">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="${basePath}/superui/superui-master/content/ui/img/photos/girl1.png" class="user-image" alt="User Image">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            <img src="${basePath}/superui/superui-master/content/ui/img/photos/girl1.png" class="img-circle" alt="User Image">
                            <p>
                                TZHSWEET的小妞
                                <small>2016年注册</small>
                            </p>
                        ...
                        <li class="user-footer">
                            ...
                            <div class="pull-right">
                                <a href="${basePath}/sendInfo/logout.do" class="btn btn-default btn-flat">退出</a>
                            </div>
                        </li>
                    </ul>
                </li>
...
<script type="text/javascript">
    ...
    $(function() {
        addTabs(({ id: '10008', title: '欢迎页', close: false, url: '${basePath}/dashboard.jsp' }));
        App.fixIframeCotent();
        var menus = [
             
              {
                  ...
                  children: [
                              { id: "10022", text: "DBA配置管理", url: "${basePath}/sendInfo/dbaManagerment.do", targetType: "iframe-tab", icon: "fa fa-spinner" }
             ...
             
              {
                  ...
                  icon: "fa fa-circle-o",
                  children: [
                       { id: "10004", text: "系统管理", url: "../components/buttons.html", targetType: "iframe-tab", icon: "fa fa-square" },
                      { id: "10003", text: "子系统管理", url: "${basePath}/sendInfo/addConfig.do", targetType: "iframe-tab", icon: "fa fa-list-alt" },
                     
                      { id: "10012", text: "实例管理", url: "${basePath}/sendInfo/contentList.do", targetType: "iframe-tab", icon: "fa fa-circle-o" },
                      {
                          id: "10203",
                          text: "申请审批",
         ...
         
              {
                  ...
                  icon: "fa fa-circle-o",
                  children: [
                       { id: "10026", text: "客户信息", targetType: "iframe-tab",  url: "../components/layer.html", icon: "fa fa-circle-o" },
                      { id: "10006", text: "我的信息", targetType: "iframe-tab", url: "../component-extend/calendar.html", icon: "fa fa-circle-o" },
                          { id: "10014", text: "广告代理信息", targetType: "iframe-tab", url: "../component-extend/timeline.html", icon: "fa fa-circle-o" }
                  ]
              ...
              },
              {
               ...
               {
                   id: "10209", text: "系统维护", isOpen: false,  icon: "fa fa-circle-o"
